                            ...
                            <div class="mb-3">
                                ...
                                <label class="control-label" for="image">Icon</label>
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            is-invalid
                                            @enderror " placeholder="Leave a comment here" id="floatingTextarea" name="icon">{{$regulation->icon}}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control @error('title')
                                            is-invalid
                                            @enderror " name="title" id="floatingInput" value="{{$regulation->title}}"  placeholder="name@example.com">
