                        ...
                        <div class="row pt-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="name" type="text" id="name" class="form-control" value="lpk tsukuba indonesia">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="slogan" type="text" id="slogan" class="form-control" value="職業訓練機関つくばインドネシア">
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        <div class="row pt-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="email" type="email" id="email" class="form-control" value="tsukubaindonesia@gmail.com">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="control-label" for="ig">Instagram Link</label>
                                    <input name="ig" type="text" id="ig" class="form-control" value="https://www.instagram.com/lpk.tsukubaindonesia/">
                                </div>
                            </div>
                        </div>
                        <div class="row pt-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="wa" type="text" id="wa" class="form-control" value="https://wa.me/6282316396737">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="tiktok" type="text" id="tiktok" class="form-control" value="https://www.tiktok.com/@tsukuba.indonesia">
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        <div class="row pt-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="vision" class="form-control" id="vision">Menjadikan LPK Tsukuba Indonesia sebagai sarana generasi muda Indonesia untuk mengembangkan potensi dan menghasilkan lulusan yang berkualitas dan profesional serta mampu bersaing di kancah internasional. Khususnya di Negara Jepang.</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="control-label" for="mission">Mission</label>
                                    <textarea name="mission" class="form-control" id="mission">1. Melatih kedisiplinan dan etos kerja sesuai standar di Jepang.
                        ...
                        <div class="row pt-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="address" class="form-control" id="address">Perum Puri Ciawi Kencana, Pasirhuni, Kec. Ciawi, Kabupaten Tasikmalaya, Jawa Barat 46156</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row pt-3">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <textarea name="history" class="form-control" id="history">LPK Tsukuba Indonesia didirikan pada bulan Agustus 2024 di Ciawi, Kabupaten Tasikmalaya, Jawa Barat Indonesia. LPK Tsukuba Indonesia adalah lembaga pendidikan bahasa Jepang untuk Program Pemagang ke Jepang, dan telah mendapatkan izin resmi dari pemerintah Indonesia.
                            ...
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        {{-- <div class="input name="name"-group-prepend">
                                            <span class="input name="name"-group-text" id="input name="name"GroupFileAddon01">Upload</span>
                                        </div> --}}
                                        <div class="custom-file">
                                            <input name="name" type="file" class="form-control" id="inputGroupFile01"
