                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
                    ...
                    <div class="max-w-5xl mx-auto">
                        <div class="text-center mb-8">
                            <h2
                                class="text-2xl md:text-3xl font-bold text-blue-600 relative inline-block animate-slideDown opacity-100">
                        ...
                        <div class="text-center mb-8 md:mb-16 animate-slideUp opacity-100">
                            <p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                                Sebagai acuan untuk dapat mengikuti keinginan dan harapan dari LPK SO kami menggunakan modul
                                sebagai
                                berikut:
                            </p>
                        </div>
                                    ...
                                    <div class="flex flex-col items-center space-y-4">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="w-6 md:w-8 h-6 md:h-8 text-blue-600" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                            </svg>
                                        </div>
                                        <h3 class="text-lg md:text-xl font-semibold text-gray-900 text-center">Minna No
                                            Nihongo I To II
                                        </h3>
                    ...
                    <div class="mt-12 md:mt-16 mb-16 md:mb-20">
                        ...
                        <div
                            ...
                            <p class="text-base md:text-xl text-gray-700 text-center">
                                Akta Notaris: <span class="font-bold text-blue-600">Mohamad Hikmat, S.H.</span> Nomor 12
                                Tanggal 26 Juli
                                2024
                            </p>
                        </div>
