...
@section('content')
    ...
    <div class="h-[30vh] w-full relative mb-10 shadow-md flex items-center justify-center">
        <img src="/assets/img/bg-tentang.webp" alt="foto-persyaratan1" class="w-full h-full object-cover absolute inset-0" />
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
                    ...
                    <div class="order-first lg:order-last">
                        <div class="relative h-64 lg:h-full w-full rounded-lg overflow-hidden">
                            <img src="assets/img/hero.jpg" alt="{{ $companyprofile->name }}"
                            ...
                            <div
                                ...
                                <h4 class="text-white text-xl font-bold mb-2 text-center">
